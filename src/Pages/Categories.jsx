        ...
        <>
            ...
            <div className='w-100 d-flex justify-content-evenly  align-items-center fs-3 px-5' style={{ margin: '100px 0' }}>
                {options.map((item, index) => (
                    <div style={{ cursor: 'pointer', backgroundColor: 'blue', color: 'white' }} className='item mt-5 p-5 rounded-4 w-100 text-center ms-3' key={index} onClick={() => handleCategory(item)} >
                        {item}
                    </div>
                ))}
            </div>
